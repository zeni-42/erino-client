...
export default function Signin(){
    ...
    const onSubmit = async (data: signUpFormData) => {
        setIsLoading(true)
        try {
            const res = await axios.post(`${process.env.NEXT_PUBLIC_BACKEND_URL}/api/v1/user/`, data,
                {
                ...
                <div className="w-full max-w-md">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        <div>
                            ...
                            <Input type="text" className={`mt-1 ${errors.fullName ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-orange-500 focus:border-orange-500"}`} {...register("fullName")} />
                            {errors.fullName && (
